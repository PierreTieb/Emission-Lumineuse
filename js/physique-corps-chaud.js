...
const PhysiqueCorpsChaud = {
   ...
   */
  comparaisonObjet(T) {
    if (T < 3800) return 'Bételgeuse (≈ 3500 K)';
    if (T < 5000) return 'Arcturus (≈ 4300 K)';
    if (T < 6000) return 'le Soleil (≈ 5800 K)';
    if (T < 7600) return 'Procyon (≈ 6500 K)';
    if (T < 9500) return 'Véga (≈ 9600 K)';
    if (T < 12000) return 'Sirius (≈ 9900 K)';
    return 'Rigel (≥ 12000 K)';
  },
